    ...
    <div className={styles.container}>
      ...
      <div className={styles.header}>
        ...
        <div className={styles.login}>
          {userRedux.logged ? (
            <Avatar id="beach-menu" onClick={handleClick} src={userRedux.data.photoURL} />
          ) : (
            <Avatar onClick={signIn} src={userRedux.data.photoURL}>
      ...
      <div className={styles.navbar}>
        ...
        <div className={styles.navbarItem}>
          <motion.p
            className={pressSchedule ? styles.navbarTextPressed : styles.navbarText}
            animate={{
        ...
        <div className={styles.navbarItem}>
          <motion.p
            className={pressGallery ? styles.navbarTextPressed : styles.navbarText}
            animate={{
        ...
        <div className={styles.navbarItem}>
          <motion.p
            className={pressAbout ? styles.navbarTextPressed : styles.navbarText}
            animate={{
